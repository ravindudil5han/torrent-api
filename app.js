// special thanks Ryuk_me

const {express,scrap1337x,scrapNyaa,scrapYts,scrapPirateBay,scrapTorLock,scrapEzTVio,torrentGalaxy,combo,rarbg,ettvCentral,zooqle,kickAss,bitSearch,glodls,magnet_dl,limeTorrent,torrentFunk,torrentProject } = require('@dil5han/torrent-api');

const app = express();

app.use('/torrent/:website/:query/:page?', (req, res, next) => {
